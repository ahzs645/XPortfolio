...
var LANG = {
    current: 'zh', // 'zh' for Chinese, 'en' for English
    zh: {
        petName: "咱家的小企鹅",
        words: [
            "",
        ...
        pageText: [
            "还记得吗？那天是小企鹅破壳而出的日子。",
            "在你的宠爱下，小企鹅一天天长大……",
            "你送Ta去读书，带Ta去旅行，陪Ta玩耍，留下了弥足珍贵的回忆！",
            "小企鹅在你的陪伴下在企鹅世界努力寻找着另一半！",
            "这些年，你陪伴小企鹅的时光犹如白驹过隙。",
            "Ta也曾努力成长，历经千锤百炼。",
            "在这相伴无数的日子里,你和小企鹅一起赢得了无数星级称号！",
            "未来，小企鹅会继续在这里陪伴着你们，想Ta了要记得来看Ta哦~"
        ],
        menu: {
            clean: "  清  洁",
            feed: "  喂  养",
    ...
    en: {
        petName: "My Little Penguin",
        words: [
            "",
            "Hello, master! Can you spend more time with me today~",
            "What a beautiful sunny day, everywhere looks so nice♫~",
            "Shuffle shuffle, like a devil's dance moves♫~",
            "Eating is the most important, no dieting for now, haha~~",
            "Let's play together, don't worry, just be happy~",
            "Bath time feels so nice, I feel so much lighter now",
            "I think I'm handsome, but it's not that obvious yet.",
            "Money isn't the problem, the problem is having no money.",
            "Rome wasn't built in a day, and neither was this belly!",
            "Hey you~ come poke me!",
            "What a beautiful sunny day, everywhere looks so nice♫~"
        ],
        pageText: [
            "Remember? That was the day little penguin hatched from its egg.",
            "Under your loving care, little penguin grew up day by day...",
            "You sent them to school, took them traveling, played with them, leaving precious memories!",
            "With your company, little penguin searched for their soulmate in penguin world!",
            "Over the years, time spent with little penguin flew by like a flash.",
            "They worked hard to grow, going through countless challenges.",
            "In all these days together, you and little penguin earned countless star titles!",
            "In the future, little penguin will continue to be here with you. Remember to visit when you miss them~"
        ],
        menu: {
            clean: "  Clean",
            feed: "  Feed",
...
function toggleLanguage() {
    ...
    if (pet.Global.Home && pet.Global.Home._display) {
        pet.Global.Home.updateLanguage();
    }
    // Update language button
    var langBtn = document.getElementById('langToggleBtn');
    if (langBtn) {
        langBtn.textContent = LANG[LANG.current].langBtn;
    }
}
...
(function (pet_1) {
    ...
    var Home = (function () {
        ...
        Home.prototype.resLoadComplete = function () {
            ...
            this._display.petName.text = getLang().petName;
            // Update menu labels
            this._display.xizao.text = getLang().menu.clean;
            this._display.chifan.text = getLang().menu.feed;
            this._display.huiyi.text = getLang().menu.history;
            this._display.xiuxian.text = getLang().menu.play;
        };
        // Method to update all text when language changes
        Home.prototype.updateLanguage = function () {
            this._words = getLang().words;
            this._display.petName.text = getLang().petName;
            this._display.xizao.text = getLang().menu.clean;
            this._display.chifan.text = getLang().menu.feed;
            this._display.huiyi.text = getLang().menu.history;
            this._display.xiuxian.text = getLang().menu.play;
            // Update page text if visible
            for (var i = 1; i <= this._pagemax; i++) {
                if (this._display["page" + i + "Text"]) {
                    this._display["page" + i + "Text"].text = getLang().pageText[i - 1];
                }
            }
        };
        //播放企鹅动画
        ...
        Home.prototype.initPageText = function () {
            var langPageText = getLang().pageText;
            for (var i = 0; i < langPageText.length; i++) {
                this._pageText[i] = langPageText[i];
            }
        };
        return Home;
    }());
