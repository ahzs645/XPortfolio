(function() {
    ...
    // Stub for portfolio manager - not available in React version
    async function getPortfolioManager() {
        return {
            getProjectsPath: (title) => 'C:\\Users\\User\\Projects\\' + (title || '').replace(/\s+/g, ''),
            getAssetsPath: () => 'C:\\Users\\User\\Assets'
        };
    }
    ...
    class ImageViewer {
        ...
        async init() {
            ...
            let appLoader = null;
            // AppLoader not available in React version - skip loading animation
