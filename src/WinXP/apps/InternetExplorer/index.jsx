...
const IE_MENUS = [
  {
    ...
    items: [
      ...
      { label: 'Edit with Code Editor', disabled: true },
      { separator: true },
    ...
    items: [
      {
        label: 'Toolbars',
        submenu: [
          { label: 'Standard Buttons', checked: true, disabled: true },
          { label: 'Address Bar', checked: true, disabled: true },
      ...
      { label: 'Text Size', submenu: [
        ...
        { label: 'Medium', checked: true, disabled: true },
        { label: 'Smaller', disabled: true },
        { label: 'Smallest', disabled: true },
      ] },
      { label: 'Encoding', disabled: true },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'MSN.com', disabled: true },
      { label: 'Windows Update', disabled: true },
    ],
  },
  {
    id: 'tools',
    ...
    items: [
      ...
      { separator: true },
      {
        ...
        submenu: [
          { label: 'Turn On Pop-up Blocker', disabled: true },
          { label: 'Pop-up Blocker Settings...', disabled: true },
        ],
      },
      { label: 'Manage Add-ons...', disabled: true },
      { separator: true },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Online Support', disabled: true },
      { label: 'Send Feedback', disabled: true },
      { separator: true },
      { label: 'For Netscape Users', disabled: true },
