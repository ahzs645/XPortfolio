...
export default class StartMenu {
    ...
    async ['_init']() {
        ...
        if (socialHtml) rightColumnPieces.append(socialHtml);
        rightColumnPieces.append(renderMenuDivider('divider-darkblue'));
        rightColumnPieces.append(recentlyUsedTriggerHtml);
        rightColumnPieces.append(renderMenuDivider('divider-darkblue'));
        if (rightPinnedHtml) rightColumnPieces.append(rightPinnedHtml);
