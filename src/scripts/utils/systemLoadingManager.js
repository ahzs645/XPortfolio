class SystemLoadingManager {
    constructor() {
        this['loadingStates'] = new Set(), this['loadingOverlay'] = null, this['xpHourglassCursor'] = this['createXPHourglassCursor'](), this['createSystemLoadingOverlay']();
    } ['createXPHourglassCursor']() {
        return 'url(\x22./assets/gui/cursors/wait.cur\x22),\x20wait';
    } ['createSystemLoadingOverlay']() {
        ...
        this['loadingStates']['clear'](), this['updateLoadingState']();
    }
}
const systemLoadingManager = new SystemLoadingManager();
export default systemLoadingManager;