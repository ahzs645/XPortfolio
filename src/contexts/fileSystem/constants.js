...
export const fileIcons = {
  ...
  '.log': '/icons/luna/file_txt.png',
  '.md': '/icons/luna/file_txt.png',
  '.ini': '/icons/xp/Notepad.png',
  '.json': '/apps/openlair-viewer/static/images/icon/coder.png',
  '.js': '/apps/openlair-viewer/static/images/icon/coder.png',
  '.jsx': '/apps/openlair-viewer/static/images/icon/coder.png',
  '.ts': '/apps/openlair-viewer/static/images/icon/coder.png',
  '.tsx': '/apps/openlair-viewer/static/images/icon/coder.png',
  '.css': '/apps/openlair-viewer/static/images/icon/coder.png',
  '.xml': '/apps/openlair-viewer/static/images/icon/coder.png',
  '.php': '/apps/openlair-viewer/static/images/icon/coder.png',
  '.mp3': '/icons/media-player.png',
  '.wav': '/icons/luna/file_generic_media.png',
  '.wma': '/icons/luna/file_generic_media.png',
  '.ogg': '/icons/luna/file_generic_media.png',
  '.flac': '/icons/luna/file_generic_media.png',
  '.aac': '/icons/luna/file_generic_media.png',
  '.mp4': '/icons/media-player.png',
  '.avi': '/icons/luna/file_generic_media.png',
  '.mov': '/icons/luna/file_generic_media.png',
  '.mkv': '/icons/luna/file_generic_media.png',
  '.wmv': '/icons/luna/file_generic_media.png',
  '.webm': '/icons/luna/file_generic_media.png',
  ...
  '.zip': '/icons/luna/folder_compressed.png',
  '.rar': '/icons/luna/folder_compressed.png',
  '.7z': '/icons/luna/folder_compressed.png',
  '.tar': '/icons/luna/folder_compressed.png',
  '.gz': '/icons/luna/folder_compressed.png',
  '.exe': '/icons/luna/file_generic_executable.png',
